...
{
	if (region.h.at === region.g.at)
	{
		return 'on line ' + region.h.at;
	}
	return 'on lines ' + region.h.at + ' through ' + region.g.at;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dK: 'hidden', dn: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dK: 'mozHidden', dn: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dK: 'msHidden', dn: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dK: 'webkitHidden', dn: 'webkitvisibilitychange' }
		: { dK: 'hidden', dn: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.d2, request.cL, true);
		} catch (e) {
...
var $author$project$Main$Msg_UrlChange = function (a) {
	return {$: 2, a: a};
};
var $author$project$Main$Msg_UrlRequest = function (a) {
	return {$: 1, a: a};
};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bN: fragment, bW: host, ab: path, cd: port_, cg: protocol, ch: query};
	});
...
var $author$project$Main$Msg_Error = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$Msg_FileContent = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$State_Loading = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$State_NotFound = {$: 2};
	...
	function (toResult, response) {
		switch (response.$) {
			...
			case 3:
				...
				return $elm$core$Result$Err(
					$elm$http$Http$BadStatus(metadata.ez));
			default:
				var body = response.b;
				return A2(
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{c4: false, aJ: r.aJ, bK: r.bK, bR: r.bR, d2: r.d2, eU: r.eU, cG: r.cG, cL: r.cL}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aJ: $elm$http$Http$emptyBody, bK: r.bK, bR: _List_Nil, d2: 'GET', eU: $elm$core$Maybe$Nothing, cG: $elm$core$Maybe$Nothing, cL: r.cL});
};
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {X: frag, aa: params, T: unvisited, cM: value, ag: visited};
	});
...
var $author$project$Main$path_filename = function (path) {
	return A2(
		...
		var parser = $elm$url$Url$Parser$oneOf(
			_List_fromArray(
				[
					...
					$elm$url$Url$Parser$s('file'),
					$elm$url$Url$Parser$string)
				]));
		var parsed_file = A2($elm$url$Url$Parser$parse, parser, url);
		if (!parsed_file.$) {
			var encoded_path = parsed_file.a;
			var path = A2(
				$elm$core$Maybe$withDefault,
				encoded_path,
				$elm$url$Url$percentDecode(encoded_path));
			return _Utils_Tuple2(
				{
					av: key,
					ad: $author$project$Main$State_Loading(
						{
							ab: path,
							ae: $author$project$Main$path_filename(path)
						}),
					aE: token
				},
				$elm$http$Http$get(
					{
						bK: $elm$http$Http$expectString(
							function (result) {
								if (!result.$) {
									var content = result.a;
									return $author$project$Main$Msg_FileContent(content);
								} else {
									return $author$project$Main$Msg_Error('Something went wrong');
								}
							}),
						cL: '/api/file/' + encoded_path
					}));
		} else {
			return _Utils_Tuple2(
				{av: key, ad: $author$project$Main$State_NotFound, aE: token},
...
var $author$project$Colors$background = A3($mdgriffith$elm_ui$Element$rgb255, 24, 26, 27);
...
var $mdgriffith$elm_ui$Internal$Style$classes = {cW: 'a', a2: 'atv', cY: 'ab', cZ: 'cx', c_: 'cy', c$: 'acb', c0: 'accx', c1: 'accy', c2: 'acr', bx: 'al', by: 'ar', c3: 'at', a3: 'ah', a4: 'av', c7: 's', db: 'bh', dc: 'b', de: 'w7', dg: 'bd', dh: 'bdt', aK: 'bn', di: 'bs', aL: 'cpe', dp: 'cp', dq: 'cpx', dr: 'cpy', O: 'c', aQ: 'ctr', aR: 'cb', aS: 'ccx', P: 'ccy', ap: 'cl', aT: 'cr', dt: 'ct', dw: 'cptr', dx: 'ctxt', dG: 'fcs', bM: 'focus-within', dH: 'fs', dI: 'g', ba: 'hbh', bb: 'hc', bU: 'he', bc: 'hf', bV: 'hfp', dL: 'hv', dM: 'ic', dO: 'fr', aV: 'lbl', dR: 'iml', dS: 'imlf', dT: 'imlp', dU: 'implw', dV: 'it', dZ: 'i', b2: 'lnk', aj: 'nb', b6: 'notxt', d7: 'ol', d9: 'or', _: 'oq', ee: 'oh', ca: 'pg', cb: 'p', ef: 'ppe', el: 'ui', co: 'r', en: 'sb', eo: 'sbx', ep: 'sby', eq: 'sbt', et: 'e', eu: 'cap', ev: 'sev', eD: 'sk', cE: 't', eG: 'tc', eH: 'w8', eI: 'w2', eJ: 'w9', eK: 'tj', a$: 'tja', eL: 'tl', eM: 'w3', eN: 'w5', eO: 'w4', eP: 'tr', eQ: 'w6', eR: 'w1', eS: 'tun', cI: 'ts', af: 'clr', eX: 'u', bs: 'wc', cR: 'we', bt: 'wf', cS: 'wfp', bv: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.c7 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.O);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.c7 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dI);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.c7 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ca);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.c7 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cb);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.c7 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.co);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.c7 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.et);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.em)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
		...
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.co) + ('-' + ($elm$core$String$fromInt(pos.bG) + ('-' + ($elm$core$String$fromInt(pos.cQ) + ('-' + $elm$core$String$fromInt(pos.bT)))))));
		case 11:
...
var $mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return _List_fromArray(
		[
			...
			A2(
			$mdgriffith$elm_ui$Internal$Model$Style,
			($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c7) + ':focus .focusable, ') + (($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c7) + '.focusable:focus, ') + ('.ui-slide-bar:focus + ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c7) + ' .focusable-thumb'))),
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
	...
	[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dL, $mdgriffith$elm_ui$Internal$Style$classes._)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dG, $mdgriffith$elm_ui$Internal$Style$classes.af)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dG, $mdgriffith$elm_ui$Internal$Style$classes._)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.a2, $mdgriffith$elm_ui$Internal$Style$classes._)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.c0,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.c0,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:only-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.c0,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.c0 + ' ~ u'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.c2 + (' ~ s.' + $mdgriffith$elm_ui$Internal$Style$classes.c0)),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.c$,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1')
							])),
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:first-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.c1,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.c1,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:only-of-type.' + $mdgriffith$elm_ui$Internal$Style$classes.c1,
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.c1 + ' ~ u'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + ($mdgriffith$elm_ui$Internal$Style$classes.c$ + (' ~ s.' + $mdgriffith$elm_ui$Internal$Style$classes.c1)),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				_List_fromArray(
					[
						...
						A2(
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c7 + ':first-child'),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot(
							$mdgriffith$elm_ui$Internal$Style$classes.c7 + ($mdgriffith$elm_ui$Internal$Style$selfName(3) + (':first-child + .' + $mdgriffith$elm_ui$Internal$Style$classes.c7))),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						$mdgriffith$elm_ui$Internal$Style$Child,
						$mdgriffith$elm_ui$Internal$Style$dot(
							$mdgriffith$elm_ui$Internal$Style$classes.c7 + ($mdgriffith$elm_ui$Internal$Style$selfName(2) + (':first-child + .' + $mdgriffith$elm_ui$Internal$Style$classes.c7))),
						_List_fromArray(
							[
								A2($mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
...
var $mdgriffith$elm_ui$Internal$Style$explainer = '\n.explain {\n    border: 6px solid rgb(174, 121, 15) !important;\n}\n.explain > .' + ($mdgriffith$elm_ui$Internal$Style$classes.c7 + (' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n.ctr {\n    border: none !important;\n}\n.explain > .ctr > .' + ($mdgriffith$elm_ui$Internal$Style$classes.c7 + ' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n')));
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c7) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.co) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c7) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c7) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.co) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c7) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aQ) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aP: closing, v: _List_Nil, S: _List_Nil, G: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								v: A2(
									$elm$core$List$cons,
									{aP: '\n}', v: _List_Nil, S: props, G: '@supports (' + (prop + (':' + (value + (') {' + parent.G))))},
									rendered.v)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.G + ('{' + (renderValues(rule.S) + (rule.aP + '}')));
		}
	};
				...
				case 0:
					...
					return _List_fromArray(
						[
							...
							('.' + ($mdgriffith$elm_ui$Internal$Style$classes.c7 + (':focus ' + (selector + '-fs  {')))) + (renderedProps + '\n}'),
							(selector + '-fs:focus-within {') + (renderedProps + '\n}'),
							('.ui-slide-bar:focus + ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.c7) + (' .focusable-thumb' + (selector + '-fs {')))) + (renderedProps + '\n}')
						]);
				default:
					return _List_fromArray(
						[
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var row = '.' + $mdgriffith$elm_ui$Internal$Style$classes.co;
				...
				var _class = '.' + cls;
				var any = '.' + $mdgriffith$elm_ui$Internal$Style$classes.c7;
				return $elm$core$List$concat(
					_List_fromArray(
						[
							A4(
			...
			case 8:
				...
				var rows = function (x) {
					...
					A2(
						$elm$core$String$join,
						' ',
						A2($elm$core$List$map, toGridLength, template.em)));
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.co) + (' / ' + ($elm$core$String$fromInt(position.co + position.bT) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.bG) + (' / ' + ($elm$core$String$fromInt(position.bG + position.cQ) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.co) + ('-' + ($elm$core$String$fromInt(position.bG) + ('-' + ($elm$core$String$fromInt(position.cQ) + ('-' + $elm$core$String$fromInt(position.bT)))))));
	...
	function (name, modifier, _v0) {
		...
		return _List_fromArray(
			[
				...
				A2($mdgriffith$elm_ui$Internal$Model$bracket, '.' + (name + ('.' + (modifier + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.cE + (', .' + (name + (' .' + (modifier + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.cE)))))))))), textAdjustment)
			]);
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.eu + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.cE + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.eu + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.cE)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bT: height / size, cs: size, cO: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.dl, adjustment.da, adjustment.dy, adjustment.d0]);
	var lineHeight = 1.5;
	...
	return {
		dl: A3($mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.c7 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.et))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c7, $mdgriffith$elm_ui$Internal$Style$classes.et, $mdgriffith$elm_ui$Internal$Style$classes.aQ, $mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.c2])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c7, $mdgriffith$elm_ui$Internal$Style$classes.et, $mdgriffith$elm_ui$Internal$Style$classes.aQ, $mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.c0])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c7, $mdgriffith$elm_ui$Internal$Style$classes.et, $mdgriffith$elm_ui$Internal$Style$classes.aQ, $mdgriffith$elm_ui$Internal$Style$classes.c1])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.c7, $mdgriffith$elm_ui$Internal$Style$classes.et, $mdgriffith$elm_ui$Internal$Style$classes.aQ, $mdgriffith$elm_ui$Internal$Style$classes.c$])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.c7 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.cE + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bs + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bb)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.c7 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.cE + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bt + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bc)))));
...
var $mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.bX, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.eE : _Utils_ap(styled.eE, existingStyles)) : _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.bX, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.eE : _Utils_ap(styled.eE, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _v1.a;
			var styles = _v1.b;
			var newStyles = $elm$core$List$isEmpty(styles) ? rendered.eE : _Utils_ap(rendered.eE, styles);
			if (!newStyles.b) {
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Keyed(
							A3($mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered.$7)),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2($mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered.$7)),
						$mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return $mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.et, $mdgriffith$elm_ui$Internal$Style$classes.cW]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.et, $mdgriffith$elm_ui$Internal$Style$classes.dc]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.et, $mdgriffith$elm_ui$Internal$Style$classes.d9]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.et, $mdgriffith$elm_ui$Internal$Style$classes.d7]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.et, $mdgriffith$elm_ui$Internal$Style$classes.dO]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aj, $mdgriffith$elm_ui$Internal$Style$classes.et, $mdgriffith$elm_ui$Internal$Style$classes.db]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.bX, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.a3 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.by);
		default:
...
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.a4 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c3);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.a4 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cY);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.a4 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c_);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.c7 + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.O + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.c7 + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.co + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.eE);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				default:
					...
					if (_v6.$ === 1) {
						return _Utils_update(
							record,
							{
								d3: $elm$core$Maybe$Just(renderMode)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{dG: $elm$core$Maybe$Nothing, dL: $elm$core$Maybe$Nothing, d3: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.el, $mdgriffith$elm_ui$Internal$Style$classes.c7, $mdgriffith$elm_ui$Internal$Style$classes.et]))),
...
var $author$project$Widgets$layout = function (_v0) {
	var title = _v0.a;
	var content = _v0.b;
	return {
		aJ: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						A3($mdgriffith$elm_ui$Element$rgb255, 211, 207, 201)),
...
var $author$project$Main$Msg_Noop = {$: 0};
var $author$project$MarkdownText$MarkdownText = $elm$core$Basics$identity;
var $author$project$Main$State_Loaded = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$complete_state = F2(
	function (prev_state, content) {
		switch (prev_state.$) {
			case 0:
				var state = prev_state.a;
				return $author$project$Main$State_Loaded(
					{aJ: content, ab: state.ab, ae: state.ae});
			case 1:
				var state = prev_state.a;
				return $author$project$Main$State_Loaded(
					{aJ: content, ab: state.ab, ae: state.ae});
			default:
				return $author$project$Main$State_NotFound;
		}
	});
...
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{aJ: r.aJ, bK: r.bK, bR: _List_Nil, d2: 'POST', eU: $elm$core$Maybe$Nothing, cG: $elm$core$Maybe$Nothing, cL: r.cL});
};
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							ad: A2($author$project$Main$complete_state, model.ad, content)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
									...
									$elm$json$Json$Encode$object(
										_List_fromArray(
											[
												...
												_Utils_Tuple2(
												'path',
												$elm$json$Json$Encode$string(state.ab)),
												_Utils_Tuple2(
												'language',
												$elm$json$Json$Encode$string(run.d_)),
												_Utils_Tuple2(
												'code',
												$elm$json$Json$Encode$string(run.ds))
											]))),
								bK: $elm$http$Http$expectWhatever(
									function (result) {
										if (!result.$) {
											return $author$project$Main$Msg_Noop;
										} else {
											return $author$project$Main$Msg_Error('TODO: Error to string');
										}
									}),
								cL: '/api/run'
							}));
...
var $author$project$Main$Msg_Run = function (a) {
	return {$: 5, a: a};
};
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.dt + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ap)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.de);
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aS + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.P + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b2)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
	});
var $author$project$Colors$linkBlue = A3($mdgriffith$elm_ui$Element$rgb255, 83, 149, 202);
...
var $author$project$Widgets$link = F2(
		...
		return A2(
			...
			A2(
				...
				$mdgriffith$elm_ui$Element$mouseOver(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$color($author$project$Colors$linkBlue)
						])),
				attributes),
			args);
	});
...
var $author$project$Fontawesome$fontawesome = $mdgriffith$elm_ui$Element$Font$external(
	{b5: 'FontAwesome', cL: '/fontawesome/css/all.css'});
var $author$project$Fontawesome$fontawesome_external_backup = $mdgriffith$elm_ui$Element$Font$external(
	{b5: 'FontAwesome', cL: 'https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.css'});
var $mdgriffith$elm_ui$Element$text = function (content) {
	return $mdgriffith$elm_ui$Internal$Model$Text(content);
};
var $author$project$Fontawesome$text = F2(
	function (attributes, text_to_render) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Element$Font$family(
					_List_fromArray(
						[$author$project$Fontawesome$fontawesome, $author$project$Fontawesome$fontawesome_external_backup])),
				attributes),
			$mdgriffith$elm_ui$Element$text(text_to_render));
	});
var $elm$core$String$trim = _String_trim;
var $author$project$Widgets$complexHeading = F4(
	function (attributes, level, label, children) {
		var id = $elm$url$Url$percentEncode(
			A3(
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							(!$elm$core$String$isEmpty(label)) ? A2(
								$author$project$Widgets$link,
								_List_fromArray(
									[
								...
								{
									be: A2($author$project$Fontawesome$text, _List_Nil, '\uF0C1'),
									cL: '#' + id
...
var $author$project$Colors$dateText = A3($mdgriffith$elm_ui$Element$rgb255, 168, 160, 149);
...
var $author$project$Widgets$contextStackFrameToString = function (frame) {
	return '(row: ' + ($elm$core$String$fromInt(frame.co) + (' col: ' + ($elm$core$String$fromInt(frame.bG) + (') ' + frame.du))));
};
var $author$project$Widgets$parserProblemToString = function (problem) {
	switch (problem.$) {
		case 0:
			var str = problem.a;
...
var $author$project$Widgets$markdownParserErrorToString = function (error) {
	var context_stack_as_string = A2(
		$elm$core$String$join,
		'',
		A2(
			$elm$core$List$map,
			...
			A2($elm$core$List$map, $author$project$Widgets$contextStackFrameToString, error.dv)));
	return '(row: ' + ($elm$core$String$fromInt(error.co) + (' col: ' + ($elm$core$String$fromInt(error.bG) + (') ' + ($author$project$Widgets$parserProblemToString(error.eg) + context_stack_as_string)))));
};
var $author$project$Widgets$markdownParserErrorsToString = function (errors) {
	return A2(
		$elm$core$String$join,
		'\n\n',
		A2($elm$core$List$map, $author$project$Widgets$markdownParserErrorToString, errors));
};
var $author$project$Widgets$markdownErrorToString = function (error) {
	if (!error.$) {
		var parser_error = error.a;
		return 'Parse error: ' + $author$project$Widgets$markdownParserErrorsToString(parser_error);
	} else {
		var error_message = error.a;
		return 'Render error: ' + error_message;
	}
};
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$ParseError = function (a) {
	return {$: 0, a: a};
};
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$RenderError = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Colors$blockQuoteLeftBar = A4($mdgriffith$elm_ui$Element$rgba255, 204, 204, 204, 0.7);
...
var $author$project$Widgets$blockQuote = function (paragraphs) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		A2(
			...
			_List_fromArray(
				[
					...
					{a7: 0, bf: 10, bm: 0, br: 0}),
					$mdgriffith$elm_ui$Element$Border$color($author$project$Colors$blockQuoteLeftBar)
				]),
			paragraphs));
};
var $author$project$Widgets$blueLink = F2(
	function (attributes, args) {
		return A2(
			$mdgriffith$elm_ui$Element$link,
			A2(
...
var $author$project$Widgets$MarkdownMsg_Run = $elm$core$Basics$identity;
...
var $author$project$Style$blockMonospaceFontSize = 16;
...
var $mdgriffith$elm_ui$Element$pointer = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.dw);
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aS + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.P + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eq + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b6)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$Colors$footerBorder = A3($mdgriffith$elm_ui$Element$rgb255, 58, 62, 65);
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bG: col, dv: contextStack, eg: problem, co: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.co, s.bG, x, s.du));
	});
	...
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {bG: col, du: context, j: indent, d: offset, co: row, ey: src};
			} else {
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.h, s.d, s.ey);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.dQ, s.d + 1, s.co + 1, 1, s.ey, s.j, s.du) : A7($elm$parser$Parser$Advanced$varHelp, i.dQ, firstOffset, s.co, s.bG + 1, s.ey, s.j, s.du);
			var name = A3($elm$core$String$slice, s.d, s1.d, s.ey);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{bL: $elm$parser$Parser$ExpectingVariable, dQ: i.dQ, ej: i.ej, h: i.h});
};
var $author$project$SyntaxHighlight$default_parser = function (color) {
	return A2(
		...
		$elm$parser$Parser$variable(
			{
				dQ: function (c) {
					return ($elm$core$Char$toCode(c) > 127) || ($elm$core$Char$isAlphaNum(c) || (c === '_'));
				},
				ej: $elm$core$Set$empty,
				h: function (c) {
					return ($elm$core$Char$toCode(c) > 127) || ($elm$core$Char$isAlpha(c) || (c === '_'));
				}
			}));
};
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.d, s.co, s.bG, s.ey);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		var adjustedOffset = (newOffset < 0) ? $elm$core$String$length(s.ey) : newOffset;
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.d, adjustedOffset) < 0,
			0,
			{bG: newCol, du: s.du, j: s.j, d: adjustedOffset, co: newRow, ey: s.ey});
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.d, s1.d, s0.ey),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.d, s.co, s.bG, s.ey);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{bG: newCol, du: s.du, j: s.j, d: newOffset, co: newRow, ey: s.ey});
	};
};
...
var $author$project$SyntaxHighlight$make_parser_for_category = function (category) {
	var parser = function (syntax) {
		return A2(
			$elm$parser$Parser$map,
			function (s) {
				return {k: category.k, cE: s};
			},
			$elm$parser$Parser$getChompedString(
				A2(
					...
					A2(
						$elm$parser$Parser$ignorer,
						$elm$parser$Parser$symbol(syntax.h),
						$elm$parser$Parser$chompUntilEndOr(syntax.g)),
					$elm$parser$Parser$oneOf(
						_List_fromArray(
							[
								$elm$parser$Parser$token(syntax.g),
								$elm$parser$Parser$succeed(0)
							])))));
	};
	return $elm$parser$Parser$oneOf(
		A2($elm$core$List$map, parser, category.M));
};
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.d, s.co, s.bG, s.ey);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $author$project$SyntaxHighlight$make_parser_for_keyword = F2(
...
var $author$project$SyntaxHighlight$make_parser_for_punctuation = F2(
	function (color, punctuation) {
		return A2(
			$elm$parser$Parser$map,
			function (s) {
				return {k: color, cE: s};
			...
			$elm$parser$Parser$getChompedString(
				$elm$parser$Parser$symbol(punctuation)));
	});
var $author$project$SyntaxHighlight$merge_whitespace = F2(
	function (whitespace, colored_text) {
		return {
			k: colored_text.k,
			cE: _Utils_ap(whitespace, colored_text.cE)
		};
	});
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {bG: s.bG + (newOffset - s.d), du: s.du, j: s.j, d: newOffset, co: s.co, ey: s.ey};
	});
...
var $elm$parser$Parser$Advanced$finalizeFloat = F6(
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		var floatOffset = A2($elm$parser$Parser$Advanced$consumeDotAndExp, intOffset, s.ey);
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.co, s.bG - (floatOffset + s.d), invalid, s.du));
		} else {
				...
				if (_Utils_eq(intOffset, floatOffset)) {
					...
					if (floatSettings.$ === 1) {
						...
						var _v1 = $elm$core$String$toFloat(
							A3($elm$core$String$slice, s.d, floatOffset, s.ey));
						if (_v1.$ === 1) {
							return A2(
								$elm$parser$Parser$Advanced$Bad,
								true,
...
var $elm$parser$Parser$Advanced$number = function (c) {
	return function (s) {
		if (A3($elm$parser$Parser$Advanced$isAsciiCode, 48, s.d, s.ey)) {
			var zeroOffset = s.d + 1;
			var baseOffset = zeroOffset + 1;
			return A3($elm$parser$Parser$Advanced$isAsciiCode, 120, zeroOffset, s.ey) ? A5(
				$elm$parser$Parser$Advanced$finalizeInt,
				c.dY,
				c.dJ,
				baseOffset,
				A2($elm$parser$Parser$Advanced$consumeBase16, baseOffset, s.ey),
				s) : (A3($elm$parser$Parser$Advanced$isAsciiCode, 111, zeroOffset, s.ey) ? A5(
				$elm$parser$Parser$Advanced$finalizeInt,
				c.dY,
				c.d6,
				baseOffset,
				A3($elm$parser$Parser$Advanced$consumeBase, 8, baseOffset, s.ey),
				s) : (A3($elm$parser$Parser$Advanced$isAsciiCode, 98, zeroOffset, s.ey) ? A5(
				$elm$parser$Parser$Advanced$finalizeInt,
				c.dY,
				c.dd,
				baseOffset,
				A3($elm$parser$Parser$Advanced$consumeBase, 2, baseOffset, s.ey),
				s) : A6(
			...
			return A6(
				...
				c.dW,
				c.dF,
				A3($elm$parser$Parser$Advanced$consumeBase, 10, s.d, s.ey),
				s);
		}
	};
};
	...
	return $elm$parser$Parser$Advanced$number(
		{
			...
			dF: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingFloat, i.dF),
			dJ: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.dJ),
			dW: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingInt, i.dW),
			dY: $elm$parser$Parser$ExpectingNumber,
			d6: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingOctal, i.d6)
		});
};
var $author$project$SyntaxHighlight$number_parser = function (color) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bG: col, du: s0.du, j: s0.j, d: offset, co: row, ey: s0.ey});
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.d, s.co, s.bG, s);
	};
};
var $elm$parser$Parser$chompWhile = $elm$parser$Parser$Advanced$chompWhile;
var $author$project$SyntaxHighlight$whitespace_parser = $elm$parser$Parser$getChompedString(
	$elm$parser$Parser$chompWhile(
		function (c) {
			return c <= ' ';
		}));
var $author$project$SyntaxHighlight$make_parser = function (syntax) {
	var punctuation_parsers = A2(
		$elm$core$List$map,
		$author$project$SyntaxHighlight$make_parser_for_punctuation(syntax.aA),
		syntax.az);
	var other_parsers = _List_fromArray(
		[
			$author$project$SyntaxHighlight$number_parser(syntax.aw),
			$author$project$SyntaxHighlight$default_parser(syntax.W)
		]);
	var keyword_parsers = A2(
		$elm$core$List$map,
		$author$project$SyntaxHighlight$make_parser_for_keyword(syntax.ar),
		syntax.as);
	var category_parsers = A2(
		$elm$core$List$map,
		$author$project$SyntaxHighlight$make_parser_for_category,
		_Utils_ap(
			_List_fromArray(
				[syntax.ao, syntax.aB]),
			syntax.ay));
	var parse_one = $elm$parser$Parser$oneOf(
		_Utils_ap(
			category_parsers,
			_Utils_ap(
				punctuation_parsers,
				_Utils_ap(keyword_parsers, other_parsers))));
	var step = function (state) {
		var update_state = function (next) {
			if (!state.b) {
				return _List_fromArray(
					[next]);
			} else {
				var last = state.a;
				var rest = state.b;
				return _Utils_eq(last.k, next.k) ? A2(
					$elm$core$List$cons,
					{
						k: last.k,
						cE: _Utils_ap(last.cE, next.cE)
					},
					rest) : A2($elm$core$List$cons, next, state);
			}
		};
		var merge_trailing_whitespace = function (trailing_whitespace) {
			if (!state.b) {
				return _List_fromArray(
					[
						{k: syntax.W, cE: trailing_whitespace}
					]);
			} else {
				var last = state.a;
				var rest = state.b;
				return A2(
					...
					{
						k: last.k,
						cE: _Utils_ap(last.cE, trailing_whitespace)
					},
					rest);
			}
		};
					...
					_List_fromArray(
						[
							...
							A2(
								...
								$author$project$SyntaxHighlight$merge_whitespace(trailing_whitespace),
								A2($elm$core$Basics$composeR, update_state, $elm$parser$Parser$Loop)),
							parse_one),
							A2(
							$elm$parser$Parser$map,
							function (_v0) {
								return $elm$parser$Parser$Done(
									$elm$core$List$reverse(
										merge_trailing_whitespace(trailing_whitespace)));
							},
							$elm$parser$Parser$succeed(0))
						]));
			},
			$author$project$SyntaxHighlight$whitespace_parser);
	};
	return A2($elm$parser$Parser$loop, _List_Nil, step);
};
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bG: col, eg: problem, co: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.co, p.bG, p.eg);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bG: 1, du: _List_Nil, j: 1, d: 0, co: 1, ey: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$SyntaxHighlight$highlight = F2(
	function (syntax, text) {
		return (text === '') ? _List_Nil : A2(
			$elm$core$Result$withDefault,
			_List_fromArray(
				[
					{k: syntax.W, cE: text}
			...
			A2(
				...
				$author$project$SyntaxHighlight$make_parser(syntax),
				text));
	});
var $author$project$Colors$horizontalSeparator = A3($mdgriffith$elm_ui$Element$rgb255, 53, 57, 59);
var $mdgriffith$elm_ui$Internal$Model$Px = function (a) {
	return {$: 0, a: a};
};
var $mdgriffith$elm_ui$Element$px = $mdgriffith$elm_ui$Internal$Model$Px;
var $author$project$Widgets$horizontalSeparator = function (width) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$color($author$project$Colors$horizontalSeparator),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
			]),
		$mdgriffith$elm_ui$Element$none);
};
...
var $author$project$Widgets$isRunnableLanguage = function (language_identifier) {
	return (language_identifier === 'sh') || (language_identifier === 'python');
};
var $elm$html$Html$pre = _VirtualDom_node('pre');
var $author$project$Style$regularFontSize = 20;
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ap + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.P)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Colors$runButtonColor = A3($mdgriffith$elm_ui$Element$rgb255, 87, 198, 103);
...
var $author$project$Style$smallFontSize = 16;
...
var $author$project$SyntaxHighlight$rgb = F3(
	function (r, g, b) {
		return {bz: b, bP: g, ci: r};
	});
var $author$project$SyntaxHighlight$syntax_cpp = {
	ao: {
		k: A3($author$project$SyntaxHighlight$rgb, 82, 165, 72),
		M: _List_fromArray(
			[
				{g: '*/', i: _List_Nil, h: '/*'},
				{g: '\n', i: _List_Nil, h: '//'}
	...
	W: A3($author$project$SyntaxHighlight$rgb, 220, 220, 220),
	aq: 'cpp',
	ar: A3($author$project$SyntaxHighlight$rgb, 65, 151, 214),
	as: _List_fromArray(
	...
	b5: 'C++',
	aw: A3($author$project$SyntaxHighlight$rgb, 175, 206, 139),
	ay: _List_fromArray(
		[
			{
			k: A3($author$project$SyntaxHighlight$rgb, 155, 155, 155),
			M: _List_fromArray(
				[
					{g: '\n', i: _List_Nil, h: '#'}
				])
	...
	az: _List_fromArray(
		['!', '%', '&', '(', ')', '*', '+', ',', '-', '.', '/', ':', ';', '<', '=', '>', '?', '@', '[', '\\', ']', '^', '`', '{', '|', '}', '~']),
	aA: A3($author$project$SyntaxHighlight$rgb, 152, 175, 180),
	aB: {
		k: A3($author$project$SyntaxHighlight$rgb, 214, 156, 117),
		M: _List_fromArray(
			[
				{
				g: '\"',
...
var $author$project$SyntaxHighlight$syntax_elm = {
	ao: {
		k: A3($author$project$SyntaxHighlight$rgb, 82, 165, 72),
		M: _List_fromArray(
			[
	...
	ar: A3($author$project$SyntaxHighlight$rgb, 65, 151, 214),
	as: _List_fromArray(
		['True', 'False', 'Bool', 'Int', 'Float', 'String', 'List', 'type', 'alias', 'case', 'of', 'Char', 'if', 'then', 'else', 'as', 'exposing', 'import', 'let', 'in', 'module']),
	b5: 'Elm',
	aw: A3($author$project$SyntaxHighlight$rgb, 175, 206, 139),
	ay: _List_Nil,
	az: _List_fromArray(
...
var $author$project$SyntaxHighlight$syntax_sh = {
	ao: {
		k: A3($author$project$SyntaxHighlight$rgb, 82, 165, 72),
		M: _List_fromArray(
			[
...
var $author$project$SyntaxHighlight$supported_syntaxes = _List_fromArray(
	[$author$project$SyntaxHighlight$syntax_cpp, $author$project$SyntaxHighlight$syntax_elm, $author$project$SyntaxHighlight$syntax_sh]);
var $author$project$SyntaxHighlight$syntax_for = function (identifier) {
	return $elm$core$List$head(
		A2(
			$elm$core$List$filter,
			function (syntax) {
				return _Utils_eq(syntax.aq, identifier);
			},
			$author$project$SyntaxHighlight$supported_syntaxes));
};
var $author$project$Colors$widgetBackground = A3($mdgriffith$elm_ui$Element$rgb255, 34, 36, 38);
var $author$project$Widgets$codeBlock = function (_v0) {
	var body = _v0.aJ;
	var language = _v0.d_;
	var title = F2(
		function (language_identifier, language_name) {
			return $author$project$Widgets$isRunnableLanguage(language_identifier) ? A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$size($author$project$Style$regularFontSize),
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(language_name),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$alignRight,
								$mdgriffith$elm_ui$Element$Background$color($author$project$Colors$runButtonColor),
								$mdgriffith$elm_ui$Element$Border$rounded(5),
								A2($mdgriffith$elm_ui$Element$paddingXY, 10, 5),
								$mdgriffith$elm_ui$Element$Font$size($author$project$Style$smallFontSize),
							...
							]),
						{
							be: A2(
								...
								_List_fromArray(
									[
										A2($author$project$Fontawesome$text, _List_Nil, '\uF04B'),
										$mdgriffith$elm_ui$Element$text(' Run')
									])),
							d8: $elm$core$Maybe$Just(
								{ds: body, d_: language_identifier})
						})
					])) : A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
	...
	var maybe_syntax = A2($elm$core$Maybe$andThen, $author$project$SyntaxHighlight$syntax_for, language);
	var color_to_string = function (_v2) {
		var r = _v2.ci;
		var g = _v2.bP;
		var b = _v2.bz;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'color',
					color_to_string(block.k))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(block.cE)
				]));
	};
	var block_content = A2(
		$elm$core$Maybe$withDefault,
		_List_fromArray(
			[
		...
		A2(
			$elm$core$Maybe$map,
			$elm$core$List$map(render),
			A2(
				$elm$core$Maybe$map,
				function (syntax) {
					return A2($author$project$SyntaxHighlight$highlight, syntax, body);
				},
				maybe_syntax)));
	var code_block = $mdgriffith$elm_ui$Element$html(
		A2($elm$html$Html$pre, _List_Nil, block_content));
	var content = function () {
		if (maybe_syntax.$ === 1) {
			return _List_fromArray(
				[code_block]);
		} else {
			var syntax = maybe_syntax.a;
			return _List_fromArray(
				[
					A2(title, syntax.aq, syntax.b5),
					$author$project$Widgets$horizontalSeparator(1),
					code_block
				]);
		}
	}();
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Border$color($author$project$Colors$footerBorder),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Colors$widgetBackground),
				$mdgriffith$elm_ui$Element$Border$rounded(10),
				A2($mdgriffith$elm_ui$Element$paddingXY, 15, 0),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Font$size($author$project$Style$blockMonospaceFontSize),
...
var $author$project$Style$inlineMonospaceFontSize = 17;
var $mdgriffith$elm_ui$Internal$Model$Monospace = {$: 2};
var $mdgriffith$elm_ui$Element$Font$monospace = $mdgriffith$elm_ui$Internal$Model$Monospace;
var $author$project$Widgets$codeSpan = function (raw_text) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Font$size($author$project$Style$inlineMonospaceFontSize),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Colors$widgetBackground)
			]),
		$mdgriffith$elm_ui$Element$text(raw_text));
};
...
var $author$project$Widgets$imageMarkdown = function (_v0) {
	var src = _v0.ey;
	var alt = _v0.c5;
	var title = _v0.ae;
	var base = $mdgriffith$elm_ui$Element$html(
		A2(
			$elm$html$Html$img,
			_List_fromArray(
				[
	...
	return A2(
		$elm$core$Maybe$withDefault,
		base,
		A2($elm$core$Maybe$map, withTitle, title));
};
var $mdgriffith$elm_ui$Internal$Flag$fontAlignment = $mdgriffith$elm_ui$Internal$Flag$flag(12);
var $mdgriffith$elm_ui$Element$Font$justify = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.eK);
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$colors = {
	a1: A4($mdgriffith$elm_ui$Element$rgba255, 204, 204, 204, 0.7),
	b2: A3($mdgriffith$elm_ui$Element$rgb255, 9, 105, 218)
};
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$blockQuote = function (els) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Border$widthEach(
					{a7: 0, bf: 10, bm: 0, br: 0}),
					$mdgriffith$elm_ui$Element$Border$color($jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$colors.a1)
				]),
			els));
};
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$codeBlock = function (_v0) {
	var body = _v0.aJ;
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$codeSpan = function (rawText) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$emphasis = $mdgriffith$elm_ui$Element$row(
	_List_fromArray(
		[$mdgriffith$elm_ui$Element$Font$italic]));
var $elm$html$Html$br = _VirtualDom_node('br');
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$hardLineBreak = $mdgriffith$elm_ui$Element$html(
	A2($elm$html$Html$br, _List_Nil, _List_Nil));
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$thematicBreak = function (thickness) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$heading = function (_v0) {
	var level = _v0.d$;
	var children = _v0.$7;
	var _v1 = function () {
		switch (level) {
			case 0:
				return _Utils_Tuple2(
					32,
					$jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$thematicBreak(1));
			case 1:
				return _Utils_Tuple2(
					28,
					$jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$thematicBreak(1));
			case 2:
				return _Utils_Tuple2(26, $mdgriffith$elm_ui$Element$none);
			case 3:
				return _Utils_Tuple2(24, $mdgriffith$elm_ui$Element$none);
			case 4:
				return _Utils_Tuple2(22, $mdgriffith$elm_ui$Element$none);
			default:
				return _Utils_Tuple2(20, $mdgriffith$elm_ui$Element$none);
		}
	}();
	var size = _v1.a;
	var decoration = _v1.b;
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$image = function (_v0) {
	var src = _v0.ey;
	var alt = _v0.c5;
	var title = _v0.ae;
	var base = A2(
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$link = F2(
	function (_v0, body) {
		...
		return A2(
				...
				]),
			{
				be: A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$color($jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$colors.b2)
						]),
					body),
				cL: destination
			});
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$orderedList = F2(
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$paragraph = $mdgriffith$elm_ui$Element$paragraph(_List_Nil);
var $mdgriffith$elm_ui$Element$Font$strike = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.eD);
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$strikethrough = $mdgriffith$elm_ui$Element$row(
	_List_fromArray(
		[$mdgriffith$elm_ui$Element$Font$strike]));
var $mdgriffith$elm_ui$Element$Font$semiBold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.eQ);
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$strong = $mdgriffith$elm_ui$Element$row(
	_List_fromArray(
		[$mdgriffith$elm_ui$Element$Font$semiBold]));
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$table = $mdgriffith$elm_ui$Element$column(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
		]));
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$tableBody = $mdgriffith$elm_ui$Element$column(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
		]));
...
var $mdgriffith$elm_ui$Element$Font$alignLeft = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.eL);
var $mdgriffith$elm_ui$Element$Font$alignRight = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.eP);
var $mdgriffith$elm_ui$Element$Font$center = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontAlignment, $mdgriffith$elm_ui$Internal$Style$classes.eG);
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$align = function (alignment) {
	if (alignment.$ === 1) {
		return _List_Nil;
	} else {
		var a = alignment.a;
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$tableCell = function (alignment) {
	return $mdgriffith$elm_ui$Element$paragraph(
		$jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$align(alignment));
};
var $mdgriffith$elm_ui$Element$fillPortion = $mdgriffith$elm_ui$Internal$Model$Fill;
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$wrapTd = F2(
	function (fillPortion, el) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width(
					$mdgriffith$elm_ui$Element$fillPortion(fillPortion))
				]),
			el);
	});
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$tableHeader = function (children) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$wrapTd(
						$elm$core$List$length(children)),
					children))
			]));
};
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$tableHeaderCell = function (alignment) {
	return $mdgriffith$elm_ui$Element$paragraph(
		$jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$align(alignment));
};
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$tableRow = function (children) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$text = $mdgriffith$elm_ui$Element$text;
...
var $mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {ah: almostShade.ah, k: almostShade.k, b$: false, d: almostShade.d, cs: almostShade.cs};
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{
					ah: 1,
					k: checked ? A4($mdgriffith$elm_ui$Element$rgba, 238 / 255, 238 / 255, 238 / 255, 0) : A3($mdgriffith$elm_ui$Element$rgb, 238 / 255, 238 / 255, 238 / 255),
					d: _Utils_Tuple2(0, 0),
					cs: 1
				}),
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$unorderedListItem = function (_v0) {
	var task = _v0.a;
	var children = _v0.b;
	var bullet = function () {
		switch (task) {
...
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$unorderedList = function (items) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_Nil,
		A2($elm$core$List$map, $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$unorderedListItem, items));
};
var $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$renderer = {
	bA: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$blockQuote,
	bE: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$codeBlock,
	bF: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$codeSpan,
	bI: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$emphasis,
	bQ: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$hardLineBreak,
	bS: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$heading,
	bX: $dillonkearns$elm_markdown$Markdown$Html$oneOf(_List_Nil),
	b_: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$image,
	b2: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$link,
	b8: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$orderedList,
	cb: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$paragraph,
	cu: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$strikethrough,
	cv: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$strong,
	cx: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$table,
	cy: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$tableBody,
	cz: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$tableCell,
	cA: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$tableHeader,
	cB: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$tableHeaderCell,
	cC: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$tableRow,
	cE: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$text,
	cF: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$thematicBreak(2),
	cK: $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$Internal$unorderedList
};
var $author$project$Widgets$unorderedListItem = function (_v0) {
	var children = _v0.b;
	var bullet = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
...
var $author$project$Widgets$unorderedList = function (items) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$Widgets$unorderedListItem, items));
};
var $author$project$Widgets$markdownRenderer = function () {
	var defaultRenderer = $jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$renderer;
	return _Utils_update(
		defaultRenderer,
		{
			bA: $author$project$Widgets$blockQuote,
			bE: $author$project$Widgets$codeBlock,
			bF: $author$project$Widgets$codeSpan,
			bS: function (_v0) {
				var level = _v0.d$;
				var rawText = _v0.eh;
				var children = _v0.$7;
				return A4(
					$author$project$Widgets$complexHeading,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$paddingEach(
							{a7: 0, bf: 0, bm: 0, br: 10})
						]),
					$dillonkearns$elm_markdown$Markdown$Block$headingLevelToInt(level),
					rawText,
					children);
			...
			bX: $dillonkearns$elm_markdown$Markdown$Html$oneOf(_List_Nil),
			b_: $author$project$Widgets$imageMarkdown,
			b2: F2(
				function (_v1, body) {
					var destination = _v1.dA;
					return A2(
						$author$project$Widgets$blueLink,
						_List_Nil,
						{
							be: A2($mdgriffith$elm_ui$Element$paragraph, _List_Nil, body),
							cL: destination
						});
				}),
			cb: $mdgriffith$elm_ui$Element$paragraph(
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$justify,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
					])),
			cK: $author$project$Widgets$unorderedList
		});
}();
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.d, s.ey);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{bG: 1, du: s.du, j: s.j, d: s.d + 1, co: s.co + 1, ey: s.ey}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{bG: s.bG + 1, du: s.du, j: s.j, d: newOffset, co: s.co, ey: s.ey}));
		};
	});
...
var $dillonkearns$elm_markdown$Markdown$OrderedList$ListItem = F4(
	function (order, intended, marker, body) {
		return {aJ: body, dX: intended, d1: marker, ed: order};
	});
...
var $dillonkearns$elm_markdown$Markdown$Parser$orderedListBlock = function (previousWasBody) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (item) {
			return A6($dillonkearns$elm_markdown$Markdown$RawBlock$OrderedListBlock, true, item.dX, item.d1, item.ed, _List_Nil, item.aJ);
		},
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$matchToInline = function (_v0) {
	...
	switch (_v1.$) {
		case 0:
			return $dillonkearns$elm_markdown$Markdown$Inline$Text(match.cE);
		case 1:
			return $dillonkearns$elm_markdown$Markdown$Inline$HardLineBreak;
		case 2:
			return $dillonkearns$elm_markdown$Markdown$Inline$CodeInline(match.cE);
		case 3:
			var _v2 = _v1.a;
			var text = _v2.a;
			var url = _v2.b;
		...
		case 4:
			...
			return A3(
				...
				url,
				maybeTitle,
				$dillonkearns$elm_markdown$Markdown$InlineParser$matchesToInlines(match.r));
		case 5:
			var _v4 = _v1.a;
			var url = _v4.a;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return {g: childMatch.g - parentMatch.t, r: childMatch.r, h: childMatch.h - parentMatch.t, cE: childMatch.cE, y: childMatch.y - parentMatch.t, t: childMatch.t - parentMatch.t, m: childMatch.m};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$organizeChildren = function (_v4) {
	...
	return {
		g: match.g,
		r: $dillonkearns$elm_markdown$Markdown$InlineParser$organizeMatches(match.r),
		h: match.h,
		cE: match.cE,
		y: match.y,
		t: match.t,
	...
	function (remaining, _v0, matchesTail) {
		...
		while (true) {
			...
			if (!remaining.b) {
				...
				if (_Utils_cmp(prevMatch.g, match.h) < 1) {
					...
					if ((_Utils_cmp(prevMatch.h, match.h) < 0) && (_Utils_cmp(prevMatch.g, match.g) > 0)) {
						var $temp$remaining = rest,
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {c: index, au: match, d5: number, bq: submatches};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		r: _List_Nil,
		h: 0,
		cE: $dillonkearns$elm_markdown$Markdown$Helpers$formatStr(text),
		y: 0,
		t: 0,
		m: $dillonkearns$elm_markdown$Markdown$InlineParser$NormalType
	};
};
var $dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = {
			g: matchModel.g,
			r: A3($dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.cE, _List_Nil, matchModel.r),
			h: matchModel.h,
			cE: matchModel.cE,
			y: matchModel.y,
			t: matchModel.t,
		...
		if (!parsedMatches.b) {
			...
			if (!_v4.$) {
				...
				return _Utils_eq(matchModel.g, matchHead.h) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.g, matchHead.h) < 0) ? A2(
					$elm$core$List$cons,
					updtMatch,
					A2(
						$elm$core$List$cons,
						$dillonkearns$elm_markdown$Markdown$InlineParser$normalMatch(
							A3($elm$core$String$slice, matchModel.g, matchHead.h, rawText)),
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{c: regMatch.c + backslashesLength, bg: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$AngleBracketOpen}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToCodeToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $elm$core$Maybe$Just(
			{
				c: regMatch.c + backslashesLength,
				bg: $elm$core$String$length(backtick),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{c: (regMatch.c + backslashesLength) - 1, bg: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							c: regMatch.c,
							bg: $elm$core$String$length(regMatch.au),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{c: regMatch.c + backslashesLength, bg: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{c: (regMatch.c + backslashesLength) - 1, bg: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageCloseToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var backslashesLength = A2(
			...
			A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{c: regMatch.c + backslashesLength, bg: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$SquareBracketClose}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		if (isEscaped) {
			...
			if (!maybeImageOpen.$) {
				return $elm$core$Maybe$Just(
					{c: index, bg: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$ImageOpenToken});
			} else {
				return $elm$core$Maybe$Just(
					{
						c: index,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToStrikethroughToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var meaning = _v2.b;
		return $elm$core$Maybe$Just(
			{c: regMatch.c + backslashesLength, bg: length, e: meaning});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	A2(
		...
		function (match) {
			return A2(
				$elm$core$Maybe$withDefault,
				match.au,
				$elm$url$Url$percentDecode(match.au));
		}));
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$urlRegex, match.cE) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				m: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.cE,
						$dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.cE)))
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$refRegexToMatch = F3(
	function (matchModel, references, maybeRegexMatch) {
		var refLabel = function (str) {
			return $elm$core$String$isEmpty(str) ? matchModel.cE : str;
		}(
			A2(
				$elm$core$Maybe$withDefault,
				matchModel.cE,
		...
		if (_v0.$ === 1) {
			...
			var regexMatchLength = function () {
				if (!maybeRegexMatch.$) {
					var match = maybeRegexMatch.a.au;
			...
			return $elm$core$Maybe$Just(
				_Utils_update(
					matchModel,
					{g: matchModel.g + regexMatchLength, m: type_}));
		}
	});
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						g: matchModel.g + $elm$core$String$length(regexMatch.au),
						m: function () {
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$checkParsedAheadOverlapping = F2(
	function (_v0, remainMatches) {
		...
		var overlappingMatches = $elm$core$List$filter(
			function (_v1) {
				var testMatch = _v1;
				return (_Utils_cmp(match.g, testMatch.h) > 0) && (_Utils_cmp(match.g, testMatch.g) < 0);
			});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$emailRegex, match.cE) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				m: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.cE,
						'mailto:' + $dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.cE)))
			})) : $elm$core$Result$Err(match);
};
					...
					$elm$parser$Parser$Advanced$succeed(
						F3(
							function (startOffset, htmlTag, endOffset) {
								return {bY: htmlTag, bg: endOffset - startOffset};
							})),
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$isCodeTokenPair = F2(
	function (closeToken, openToken) {
		...
		if (!_v0.$) {
			if (!_v0.a) {
				var _v1 = _v0.a;
				return _Utils_eq(openToken.bg - 1, closeToken.bg);
			} else {
				var _v2 = _v0.a;
				return _Utils_eq(openToken.bg, closeToken.bg);
			}
		} else {
			return false;
		}
	...
	function (closeToken, openToken) {
		...
		if (_v0.$ === 7) {
			...
			if (_v1.$ === 7) {
				var closeChar = _v1.a;
				var close = _v1.b;
				return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(open.aX, open.aZ) || _Utils_eq(close.aX, close.aZ)) ? ((!(!A2($elm$core$Basics$modBy, 3, closeToken.bg + openToken.bg))) || ((!A2($elm$core$Basics$modBy, 3, closeToken.bg)) && (!A2($elm$core$Basics$modBy, 3, openToken.bg)))) : true) : false;
			} else {
				return false;
			}
		} else {
	...
	function (closeToken, openToken) {
		var _v0 = function () {
			...
			if (_v1.$ === 9) {
				if (!_v1.a) {
					var _v2 = _v1.a;
					return _Utils_Tuple2(true, openToken.bg - 1);
				} else {
					var _v3 = _v1.a;
					return _Utils_Tuple2(true, openToken.bg);
				}
			} else {
		...
		var _v4 = function () {
			...
			if (_v5.$ === 9) {
				if (!_v5.a) {
					var _v6 = _v5.a;
					return _Utils_Tuple2(true, closeToken.bg - 1);
				} else {
					var _v7 = _v5.a;
					return _Utils_Tuple2(true, closeToken.bg);
				}
			} else {
				return _Utils_Tuple2(false, 0);
			}
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {g: token.c + token.bg, r: _List_Nil, h: token.c, cE: '', y: 0, t: 0, m: type_};
	});
	...
	function (closeToken, matches, references, rawText, _v32) {
		...
		var updatedOpenToken = function () {
			...
			if ((!_v33.$) && (!_v33.a)) {
				...
				return _Utils_update(
					openToken,
					{c: openToken.c + 1, bg: openToken.bg - 1});
			} else {
				return openToken;
			}
		}();
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emphasisToMatch = F5(
	function (references, rawText, closeToken, tokensTail, _v25) {
		...
		var updt = (!remainLength) ? {aO: closeToken, ax: openToken, aY: remainTokens, a0: tokensTail} : ((remainLength > 0) ? {
			aO: closeToken,
			ax: _Utils_update(
				openToken,
			...
			a0: A2(
				...
				_Utils_update(
					closeToken,
					{c: closeToken.c + openToken.bg, bg: -remainLength}),
				tokensTail)
		});
		var match = A7(
			$dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
			...
			$dillonkearns$elm_markdown$Markdown$InlineParser$EmphasisType(updt.ax.bg),
			updt.ax,
			updt.aO,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple3(updt.a0, match, updt.aY);
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch = F7(
	function (references, rawText, processText, type_, openToken, closeToken, innerTokens) {
		var textStart = openToken.c + openToken.bg;
		...
		var match = {g: end, r: _List_Nil, h: start, cE: text, y: textEnd, t: textStart, m: type_};
		var matches = A2(
			$elm$core$List$map,
			function (_v0) {
				var matchModel = _v0;
		...
		return {g: end, r: matches, h: start, cE: text, y: textEnd, t: textStart, m: type_};
	});
			...
			return A3(
				...
				F2(
					function (headerCell, alignment) {
						return {aI: alignment, be: headerCell};
					}),
				headers,
				columnAlignments);
		};
...
var $dillonkearns$elm_markdown$Parser$Token$backtick = A2(
	...
	'`',
	$elm$parser$Parser$Expecting('a \'`\''));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$backtick = {aM: '`', aW: 0, aE: $dillonkearns$elm_markdown$Parser$Token$backtick};
	...
	function (minLength, fenceCharacter) {
		var builtTokens = A3(
			...
			A2(
				...
				minLength,
				$elm$parser$Parser$Advanced$token(fenceCharacter.aE)));
		return A2(
			$elm$parser$Parser$Advanced$mapChompedString,
			F2(
				function (str, _v0) {
...
var $dillonkearns$elm_markdown$Parser$Token$tilde = A2(
	...
	'~',
	$elm$parser$Parser$Expecting('a `~`'));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$tilde = {aM: '~', aW: 1, aE: $dillonkearns$elm_markdown$Parser$Token$tilde};
			...
			$elm$parser$Parser$Advanced$succeed(
				F2(
					function (indent, _v0) {
						var character = _v0.a;
						var length = _v0.b;
						return {aN: character, bd: indent, bg: length};
					})),
			...
			[
				...
				A2(
					...
					A2(
						...
						$dillonkearns$elm_markdown$Markdown$CodeBlock$codeBlockLine(fence.bd)),
					$elm$parser$Parser$Advanced$getOffset),
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.d, s.co, s.bG, s.ey);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			$elm$parser$Parser$Advanced$Bad,
			false,
			A4($elm$parser$Parser$Advanced$fromInfo, newRow, newCol, expecting, s.du)) : A3(
			$elm$parser$Parser$Advanced$Good,
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {bG: col, du: context, co: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {bG: s.bG, du: newContext, j: s.j, d: s.d, co: s.co, ey: s.ey};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.co, s0.bG, context),
						s0.du),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
				...
				return A3(
					...
					p,
					a,
					A2($elm$parser$Parser$Advanced$changeContext, s0.du, s1));
			} else {
				var step = _v1;
				return step;
			}
		...
		function (listmarker, unparsedListItem) {
			switch (unparsedListItem.$) {
				...
				case 1:
					...
					return {aJ: body, d1: listmarker, n: $elm$core$Maybe$Nothing};
				default:
					return {aJ: '', d1: listmarker, n: $elm$core$Maybe$Nothing};
			}
		});
	return A2(
		$elm$parser$Parser$Advanced$map,
							...
							return $elm$parser$Parser$Advanced$succeed(
								{
									...
									b: A2(
										...
										$dillonkearns$elm_markdown$Markdown$RawBlock$CodeBlock(
											{
												aJ: A2($dillonkearns$elm_markdown$Markdown$Parser$joinStringsPreserveAll, block2.aJ, block1.aJ),
					...
					case 3:
						...
						switch (newRawBlock.$) {
							case 3:
								...
								if (_Utils_eq(openListItem2.d1, openListItem1.d1)) {
									var _v59 = A2(
										$elm$parser$Parser$Advanced$run,
										$dillonkearns$elm_markdown$Markdown$Parser$cyclic$rawBlockParser(),
										openListItem2.aJ);
										...
										b: A2(
											...
											A4(
												...
												_Utils_update(
													openListItem2,
													{
														aJ: A3($dillonkearns$elm_markdown$Markdown$Parser$joinRawStringsWith, '\n', openListItem2.aJ, body1)
													})),
											rest)
									});
							default:
			...
			function (_v24) {
				...
				return A3(
					...
					function (parsedHeaderLabel) {
						return {aI: alignment, be: parsedHeaderLabel};
					},
					label);
			},
			header);
	...
	function (linkReferences, rawBlock) {
		switch (rawBlock.$) {
					...
					A2(
						...
						$elm$core$List$reverse(
							A2(
								$elm$core$List$map,
								function (item) {
									return A2(parseItem, item.n, item.aJ);
								},
								unparsedItems))));
			case 4:
				var tight = rawBlock.a;
			...
			case 6:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$CodeBlock(
						{aJ: codeBlockBody, d_: $elm$core$Maybe$Nothing}));
			case 8:
				var _v22 = rawBlock.a;
				var header = _v22.a;
				var rows = _v22.b;
			...
			case 9:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
						A2($dillonkearns$elm_markdown$Markdown$Parser$inlineParseHelper, linkReferences, text.cj)));
			default:
				var raw = rawBlock.b;
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
													...
													A2(
														...
														A4(
															...
															_Utils_update(
																openListItem,
																{
																	aJ: A3($dillonkearns$elm_markdown$Markdown$Parser$joinRawStringsWith, '', openListItem.aJ, newString)
																})),
														rest))
											});
									});
								...
								if (_v3.b.b) {
									switch (_v3.b.a.$) {
										case 3:
											...
											return ($elm$core$String$trim(openListItem.aJ) === '') ? A2(
												$elm$parser$Parser$Advanced$map,
												function (block) {
													return $elm$parser$Parser$Advanced$Loop(block);
												},
	...
	return function (block) {
		switch (block.$) {
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.bE(codeBlock)));
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.cF));
			case 3:
...
var $dillonkearns$elm_markdown$Markdown$Renderer$renderSingleInline = F2(
	function (renderer, inline) {
		switch (inline.$) {
			...
			case 2:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.b_(
							{
								c5: $dillonkearns$elm_markdown$Markdown$Block$extractInlineText(children),
								ey: src,
								ae: title
							})));
			case 7:
			...
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.bQ));
			default:
				var html = inline.a;
				if (!html.$) {
					var tag = html.a;
...
var $author$project$Widgets$parseMarkdown = function (markdown_source) {
	return A2(
		$elm$core$Result$andThen,
		function (blocks) {
			return A2(
				$elm$core$Result$mapError,
				$jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$RenderError,
				A2($dillonkearns$elm_markdown$Markdown$Renderer$render, $author$project$Widgets$markdownRenderer, blocks));
		},
		A2(
			$elm$core$Result$mapError,
			$jmpavlick$elm_ui_markdown$Markdown$Renderer$ElmUi$ParseError,
			$dillonkearns$elm_markdown$Markdown$Parser$parse(markdown_source)));
};
var $author$project$MarkdownText$source = function (markdown) {
	var src = markdown;
	return src;
};
var $author$project$Widgets$markdownBody = function (body) {
	var parsed_markdown = $author$project$Widgets$parseMarkdown(
		$author$project$MarkdownText$source(body));
	if (!parsed_markdown.$) {
		var value = parsed_markdown.a;
		return value;
	} else {
		var error = parsed_markdown.a;
		return _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text(
				'Error at parsing markdown: ' + $author$project$Widgets$markdownErrorToString(error))
			]);
	}
};
var $author$project$Style$spacingBeetweenParagraphs = 15;
var $author$project$Main$view_content = function (state) {
	return A2(
		$mdgriffith$elm_ui$Element$map,
		function (msg) {
			var code = msg;
			return $author$project$Main$Msg_Run(code);
		},
		A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$spacing($author$project$Style$spacingBeetweenParagraphs),
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
				]),
			_Utils_ap(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(state.ae)
							])),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Font$italic,
								$mdgriffith$elm_ui$Element$Font$color($author$project$Colors$dateText),
								$mdgriffith$elm_ui$Element$Font$size($author$project$Style$smallFontSize)
							]),
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(state.ab)
							]))
					]),
				$author$project$Widgets$markdownBody(state.aJ))));
};
var $author$project$Main$view = function (model) {
	var _v0 = model.ad;
	switch (_v0.$) {
		case 0:
			return _Utils_Tuple2('Loading...', $mdgriffith$elm_ui$Element$none);
		case 1:
			var state = _v0.a;
			return _Utils_Tuple2(
				state.ae,
				$author$project$Main$view_content(state));
		default:
			return _Utils_Tuple2('Not found', $mdgriffith$elm_ui$Element$none);
	}
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		dP: $author$project$Main$init,
		ea: $author$project$Main$Msg_UrlChange,
		eb: $author$project$Main$Msg_UrlRequest,
		eF: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		eY: $author$project$Main$update,
		eZ: A2($elm$core$Basics$composeR, $author$project$Main$view, $author$project$Widgets$layout)
	});
